...
import { updateCollectionV1, UpdateCollectionV1InstructionDataArgs } from '../../generated';
export type UpdateCollectionArgs = Omit<Parameters<typeof updateCollectionV1>[1], 'newName' | 'newUri'> & {
